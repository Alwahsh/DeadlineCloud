...
public class WebMinion
{
	...
	/**
	 * @add a new group. Note that when a user adds a group, he doesn't get subscribed to it.
	 */
	...
	public static void postDeadline(String groupId, String userId, Deadline deadline)
	{
		...
		try {
	        ...
	        nameValuePairs.add(new BasicNameValuePair("deadline[time]", String.valueOf(deadline.getCalendar())));
	        httppost.setEntity(new UrlEncodedFormEntity(nameValuePairs));
